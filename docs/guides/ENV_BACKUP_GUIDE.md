...
up anywhere. If this machine is lost, every secret in it (Mongo URI, JWT secret, OpenAI/XAI/
Google keys, Stripe keys, Postmark token, AWS credentials, ...) has to be regenerated by hand.
