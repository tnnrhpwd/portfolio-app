...
- [ ] **Keep the install/update banner copy plain and factual**, consistent with Phase 1's tone — e.g. "This adds local automation and voice control, running on your PC" rather than "Enhance with Simple Addon" styled as a pitch. State what it does and let the person decide.
