 ...
 *
 * One decimal, no trailing `.0`. A live byte count divided straight through
 * rendered as `11.390175819396973 MB`, which is noise in a KPI card at any
 * width and overflows a phone's card outright: `10.4 GB` reads as a size, the
 * raw float reads as a bug. */
