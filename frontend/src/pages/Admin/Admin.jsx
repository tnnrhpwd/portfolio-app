...
function Admin() {
  ...
  // ── Home Title (dynamic headline rules) state ──
  const [homeTitleSettings, setHomeTitleSettings] = useState(null); // { defaultTitle, rules }
  ...
  // ═══════════════ Fetch Home Title settings (default + rules) ═══════════════
  ...
  // Rule list editing helpers (all operate on local state; Save persists to server)
  ...
  const handleSectionToggle = useCallback((sectionName, isOpen) => {
    ...
    if (sectionName === "hometitle" && !homeTitleSettings) fetchHomeTitleSettings();
  }, [users, rawData, allData, homeTitleSettings, fetchUsers, fetchRawData, fetchAllData, fetchHomeTitleSettings]);
        ...
        <section className="admin-section-tile">
          ...
          {d && (
            <>
              ...
              {/* ─── Home Title (dynamic headline rules) ─── */}
              <CollapsibleSection
                title="Home Title Rules"
                defaultCollapsed={true}
                onToggle={(isOpen) => handleSectionToggle("hometitle", isOpen)}
              >
