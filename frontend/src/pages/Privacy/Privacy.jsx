    ...
    return (<>
        ...
        <div className='privacy'>
            ...
            <div className='privacy-body'>
                ...
                <div className='privacy-body-text'>When ordering or registering on our site, as appropriate, you may be asked to enter your: name, e-mail address, mailing address, phone number or credit card information.</div>
                ...
                <div className='privacy-body-text'>◽To process transactions</div>
                <div className='privacy-body-text'>◽To administer a contest, promotion, survey or other site feature</div>
                <div className='privacy-body-text'>◽To send periodic emails</div>
                <div className='privacy-body-title'>The email address you provide for order processing, will only be used to send you information and updates pertaining to your order.</div>
