"""
Simple Addon — Eye Tracking Engine
    ...
    def _save_online_calibration(self, output_file, src_points, dst_points, weights, poses,
        ...
        cal_data = {
            ...
            "pipeline": {
                ...
                "processWidth": int(self.process_width),
                "processHeight": int(self.process_height),
                "captureWidth": int(self.capture_width),
                "captureHeight": int(self.capture_height),
            },
            "points": agg,
...
def main():
    parser = argparse.ArgumentParser(description="Simple Eye Tracker")
