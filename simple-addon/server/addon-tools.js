/**
 * OpenAI Function-Calling Tool Definitions for Simple Addon
 *
      ...
      parameters: {
        ...
        properties: {
          ...
          location: {
            ...
            description: 'Where to save the file. Use "desktop", "documents", "downloads" for standard folders, "workspace" for the Simple workspace, or "custom" with custom_path.',
          },
    ...
    case 'save_file': {
      ...
      switch (args.location) {
        ...
        case 'downloads':
          ...
          break;
        case 'workspace':
          targetDir = path.join(os.homedir(), 'Documents', 'Simple', 'Workspace', 'files');
          break;
        case 'custom':
