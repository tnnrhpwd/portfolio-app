...
node simple-addon/server/automation/eval/cli.js

# Run a single scenario file
node simple-addon/server/automation/eval/cli.js simple-addon/server/automation/eval/scenarios/01-shell-smoke.json

# Force every step into dry-run (no side effects)
node simple-addon/server/automation/eval/cli.js --dry
```
...
- Scenarios 18-20 are the three **perturbed-UI axis** regression scenarios
  called for in docs/implementation/BACKLOG.md — all three named
