 ...
 *
 * Automates the 10 scenarios described in docs/implementation/agent.md's
 ...
 * the readiness gates in docs/implementation/BACKLOG.md), not on every commit.
 *
 ...
 * the "reliability tally" described in docs/implementation/BACKLOG.md.
 */
