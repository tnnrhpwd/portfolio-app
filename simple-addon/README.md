...
System tray application that runs the Simple AI server locally. When the portfolio frontend at `sthopwood.com/net` detects this addon running, it unlocks local AI features (HuggingFace models, GitHub Models, PC action execution).
...
3. Python 3 is detected and a virtual environment is auto-created at `%LOCALAPPDATA%/Simple/venv`
...
| Data | Path |
|------|------|
| Settings | `~/Documents/Simple/Resources/settings.json` |
| Behaviors | `~/Documents/Simple/Resources/Behaviors/*.txt` |
| Personality | `~/Documents/Simple/Resources/Personality/*.md` |
| Memory | `~/Documents/Simple/Resources/Memory/*` |
| Avatars | `~/Documents/Simple/Resources/Agents/avatars/*` |
| Venv | `%LOCALAPPDATA%/Simple/venv/` |
| SSL Certs | `%LOCALAPPDATA%/Simple/certs/` |
